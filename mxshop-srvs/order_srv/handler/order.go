...
func (o *OrderListener) ExecuteLocalTransaction(msg *primitive.Message) primitive.LocalTransactionState {
	...
	goods, err := global.GoodsSrcClient.BatchGetGoods(context.Background(), &proto.BatchGoodsIdInfo{Id: goodsIds})
	if err != nil {
	...
	*/
	...
	//发送延时消息
	p, err := rocketmq.NewProducer(producer.WithNameServer([]string{"192.168.124.4:9876"}))
	if err != nil {
		panic("生成producer失败")
	}
	...
	msg.WithDelayTimeLevel(16) //16=30m
...
func (*OrderServer) CreateOrder(c context.Context, req *proto.OrderRequest) (*proto.OrderInfoResponse, error) {
	/*	新建订单
		...
		5. 从购物车中删除已购买的记录
	*/
	orderListener := OrderListener{Ctx: c}
	p, err := rocketmq.NewTransactionProducer(
		&orderListener,
		producer.WithNameServer([]string{"192.168.124.4:9876"}),
	)
	if err != nil {
...
func (*OrderServer) OrderList(c context.Context, req *proto.OrderFilterRequest) (*proto.OrderListResponse, error) {
	...
	var total int64
	global.DB.Model(&model.OrderInfo{User: req.UserId}).Count(&total)
