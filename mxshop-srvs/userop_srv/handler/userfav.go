...
func (*UserOpServer) GetFavList(c context.Context, req *proto.UserFavRequest) (*proto.UserFavListResponse, error) {
...
func (*UserOpServer) AddUserFav(c context.Context, req *proto.UserFavRequest) (*emptypb.Empty, error) {
...
func (*UserOpServer) DeleteUserFav(c context.Context, req *proto.UserFavRequest) (*emptypb.Empty, error) {
...
func (*UserOpServer) GetUserFavDetail(c context.Context, req *proto.UserFavRequest) (*emptypb.Empty, error) {
	var userfav model.UserFav
