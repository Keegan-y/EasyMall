...
func (*UserOpServer) GetAddressList(c context.Context, req *proto.AddressRequest) (*proto.AddressListResponse, error) {
...
func (*UserOpServer) CreateAddress(c context.Context, req *proto.AddressRequest) (*proto.AddressResponse, error) {
...
func (*UserOpServer) DeleteAddress(c context.Context, req *proto.AddressRequest) (*emptypb.Empty, error) {
...
func (*UserOpServer) UpdateAddress(c context.Context, req *proto.AddressRequest) (*emptypb.Empty, error) {
	var address model.Address
