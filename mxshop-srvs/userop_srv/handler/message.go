...
func (*UserOpServer) MessageList(c context.Context, req *proto.MessageRequest) (*proto.MessageListResponse, error) {
...
func (*UserOpServer) CreateMessage(c context.Context, req *proto.MessageRequest) (*proto.MessageResponse, error) {
